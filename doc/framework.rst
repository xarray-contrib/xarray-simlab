...
has to add custom dependencies, but a checking system is provided
:ref:`create_model_process`. An ordering that is computationally consistent can 
then be obtained using topological sorting. This is done at Model object creation.
